...
class eZSurveyQuestionAnswer extends eZSurveyQuestion
{
    ...
    function eZSurveyQuestionAnswer( $row = false )
    {
        $row['type'] = 'QuestionAnswer';
    ...
    */
    ...
    function result()
    {
        ...
        $result = eZSurveyQuestionAnswer::fetchResult( $this, $contentObjectID, $contentClassAttributeID, $languageCode );
             ...
             $http->hasPostVariable( $postSurveyExtraInfoAnswer ) )
        {
            ...
            else
            {
                eZDebug::writeWarning( 'Answer: ' . $answer . ' and internal key: ' . $this->ExtraInfo['extra_info']['value'] . ' is not equal',
                                       'eZSurveyQuestionAnswer::extraInfoAnswer' );
            }
        }
        return $surveyAnswer;
    }
...
eZSurveyQuestion::registerQuestionType( ezpI18n::tr( 'survey', 'Question / Answer' ),
                                        'QuestionAnswer' );
