...
{section var=option loop=$question.options}
    <div class="element"><label><input id="{$attr_id}_{$option.id}" name="{$attr_name}" type="radio" value="{$option.value}"{if is_set($previous_vars.answer)}{if $previous_vars.answer|eq($option.value)} checked="checked"{/if}{/if} onclick="synchFormElements( '{$attr_id}_{$option.id}', '{$attr_alternative}', false );" />{$option.label}</label></div>
{/section}
...
{section var=option loop=$question.options}
    <div class="block"><label><input id="{$attr_id}_{$option.id}" name="{$attr_name}" type="radio" value="{$option.value}"{if is_set($previous_vars.answer)}{if $previous_vars.answer|eq($option.value)} checked="checked"{/if}{/if} onclick="synchFormElements( '{$attr_id}_{$option.id}', '{$attr_alternative}', false );" />{$option.label}</label></div>
{/section}
{if $question.extra_info.enabled|eq(1)}
...
<select name="{$attr_name}" onclick="synchFormElements( '{$attr_id}', '{$attr_alternative}', true );>
  {section var=option loop=$question.options}
    <option value="{$option.value}"{if is_set($previous_vars.answer)}{if $previous_vars.answer|eq($option.value)} selected="selected"{/if}{/if}>{$option.label}</option>
  {/section}
   {if $question.extra_info.enabled|eq(1)}
...
{section var=option loop=$options}
    <div class="element"><label><input id="{$attr_id}_{$option.id}" name="{$attr_name}" type="radio" value="{$option.value}"{if is_set($survey_validation.post_variables.variables[$question.id])}{section show=$option.toggled|eq(1)} checked="checked"{/section}{/if} onclick="synchFormElements( '{$attr_id}_{$option.id}', '{$attr_alternative}', false );" />{$option.label}</label></div>
{/section}
{if $question.extra_info.enabled|eq(1)}
...
<select name="{$attr_name}" onclick="synchFormElements( '{$attr_id}', '{$attr_alternative}', true );">
  {section var=option loop=$options}
    <option value="{$option.value}"{if is_set($survey_validation.post_variables.variables[$question.id])}{section show=$option.toggled|eq(1)} selected="selected"{/section}{/if}>{$option.label}</option>
  {/section}
   {if $question.extra_info.enabled|eq(1)}
